...
const translations = {
    en: {
        ...
        stats: "Stats",
        settings: "Settings",
        community: "Community", // ✅ ADDED: Community translation
    ...
    bn: {
        ...
        stats: "পরিসংখ্যান",
        settings: "সেটিংস",
        community: "সম্প্রদায়", // ✅ ADDED: Community translation
        ...
        <View style={styles.sectionContainer}>
            ...
            <View style={styles.quickActionsContainer}>
                {[
                    ...
                    // ✅ ADDED: Button to navigate to the Community screen
                ...
                <View style={styles.header}>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                        <TouchableOpacity onPress={() => setLanguage(language === "en" ? "bn" : "en")}>
                            <Text style={{ marginRight: 15, fontWeight: "bold", color: "#333", fontSize: 16 }}>
...
const styles = StyleSheet.create({
    ...
    quickActionsContainer: {
        flexDirection: 'row',
        justifyContent: 'space-between', // ✅ UPDATED: for better spacing with 5 items
        marginTop: 15,
    },
    actionButton: {
        ...
        borderRadius: 15,
        alignItems: 'center',
        width: '18%', // ✅ UPDATED: Adjusted width for 5 items
    },
    actionButtonText: { color: '#fff', marginTop: 5, fontWeight: '500', fontSize: 12, textAlign: 'center' },
    energyCardContainer: {
        flexDirection: 'row',
        justifyContent: 'space-between',
        marginTop: 15,
    ...
    energyCardValue: { fontSize: 18, fontWeight: 'bold', marginVertical: 8 },
    energyCardLabel: { fontSize: 14, color: '#666' },
    activityItem: {
        flexDirection: 'row',
        alignItems: 'center',
        backgroundColor: '#fff',
    ...
    activityDescription: { fontSize: 16, color: '#333' },
    activityTimestamp: { fontSize: 12, color: '#999', marginTop: 2 },
    ...
    weatherTemp: { fontSize: 24, fontWeight: 'bold', marginVertical: 5 },
    weatherCondition: { fontSize: 16, color: '#666' },
    weatherLocation: { fontSize: 12, color: '#999', marginTop: 5 },
    marketCard: {
        backgroundColor: '#fff',
        borderRadius: 15,
        padding: 15,
    ...
    marketTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 10, textAlign: 'center' },
    marketRow: {
        flexDirection: 'row',
        justifyContent: 'space-between',
        marginVertical: 5,
    },
    marketLabel: { fontSize: 14, color: '#666' },
    marketValue: { fontSize: 14, fontWeight: 'bold' },
    goalItem: {
        backgroundColor: '#fff',
        padding: 15,
        borderRadius: 10,
    ...
    goalProgressText: { alignSelf: 'flex-end', fontSize: 12, color: '#666', marginBottom: 5 },
